...
CREATE TABLE `book` (
  ...
  CONSTRAINT `book_ibfk_2` FOREIGN KEY (`status_id`) REFERENCES `status` (`id`)
...
CREATE TABLE `book_item` (
  ...
  CONSTRAINT `book_item_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`)
...
--
-- Dumping routines for database 'cours'
--
...
-- Dump completed on 2021-02-18 17:19:27
